...
// import 'dart:convert';
//
// CategoriyaProduct categoriyaProductFromJson(String str) => CategoriyaProduct.fromJson(json.decode(str));
//
// String categoriyaProductToJson(CategoriyaProduct data) => json.encode(data.toJson());
//
