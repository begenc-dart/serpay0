...
class DiscountList extends StatelessWidget {
  List<DiscountProduct> dis;

  DiscountList({required this.dis});
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
          (context, index) => InkWell(
                onTap: () {
                  HistoryProduct().history(dis[index].productId);
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => ProductDetails(
                            productId: dis[index].productId,
                          )));
                },
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Stack(children: [
                      Row(
                        children: [
                          Expanded(
                            ...
                            child: Stack(
                              children: [
                                dis[index].images.length != 0
                                    ? CarouselSlider.builder(
                                        itemCount: dis[index].images.length,
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      dis[index].priceOld != null
                                          ? Text(
                                              "${dis[index].priceOld} TMT",
                                              style: CustomTextStyle.disprice(
                                                  context),
                                            )
                                          : Container(),
                                      ProductLikeList(
                                          like: dis[index].isLiked,
                                          id: dis[index].productId)
                                    ],
                                  ),
                                  Padding(
                      ...
                      dis[index].isNew != null
                          ? Positioned(
                              top: dis[index].discount != null ? -5 : -22,
                              left: -33,
