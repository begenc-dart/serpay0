...
NewAndProduct newProductFromJson(String str) => NewAndProduct.fromJson(json.decode(str));

String newProductToJson(NewAndProduct data) => json.encode(data.toJson());
...
class NewAndProduct {
  ...
  List<NewProductElement> newProducts;

  factory NewAndProduct.fromJson(Map<String, dynamic> json) => NewAndProduct(
    newProducts: List<NewProductElement>.from(json["new_products"].map((x) => NewProductElement.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "new_products": newProducts == null ? null : List<dynamic>.from(newProducts.map((x) => x.toJson())),
  };
}

class NewProductElement {
  NewProductElement({
    required this.id,
  ...
  factory NewProductElement.fromJson(Map<String, dynamic> json) => NewProductElement(
