...
class ActionModel {
  ...
  List<ActionProduct>? actionProducts;
  int? count;

  factory ActionModel.fromJson(Map<String, dynamic> json) => ActionModel(
    actionProducts: json["action_products"] == null ? null :List<ActionProduct>.from(json["action_products"].map((x) => ActionProduct.fromJson(x))),
    count: json["count"] == null ? null : json["count"],
  );

  Map<String, dynamic> toJson() => {
    "action_products": actionProducts == null ? null : List<dynamic>.from(actionProducts!.map((x) => x.toJson())),
